...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pemasukkan = findViewById(R.id.buttonPemasukkan);
...
//        sa = (int) c.getDouble(c.getColumnIndex("yosaldo"));
        ...
        pengeluaran.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this, LihatPemasukanActivity.class);
                startActivity(i);
            }
        });
        ...
        pemasukkan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this, LihatPengeluaranActivity.class);
                startActivity(i);
            }
        });
        ...
        tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jud.trim().length() == 0 ||har.trim().length() == 0 ||kategori.getSelectedItemPosition() == 0){
                  Toast.makeText(getApplicationContext(), "Silahkan lengkapi form terlbih dahulu", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    judul.getText().clear();
                    harga.getText().clear();
                    Toast.makeText(getApplicationContext(), "Data berhasil dimasukkan ke tabel " + tableName, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
